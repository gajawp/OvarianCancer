...
ORIGINAL_TRAIN_RGB_DIR = MASK_AWARE_DATASET_ROOT / "train" / "images"
ORIGINAL_TRAIN_MASK_DIR = MASK_AWARE_DATASET_ROOT / "train" / "masks"

MALIGNANT_AUG_DATASET_ROOT = (
    PROJECT_ROOT / "datasets" / "OTU_2d_ds2net_rgb_mask_padding20_malignant_aug4"
)
TRAIN_RGB_DIR = MALIGNANT_AUG_DATASET_ROOT / "train" / "images"
TRAIN_MASK_DIR = MALIGNANT_AUG_DATASET_ROOT / "train" / "masks"
VAL_RGB_DIR = MASK_AWARE_DATASET_ROOT / "val" / "images"
VAL_MASK_DIR = MASK_AWARE_DATASET_ROOT / "val" / "masks"

ORIGINAL_TRAIN_LIST = MASK_AWARE_DATASET_ROOT / "train_rgb_mask_cls.txt"
TRAIN_LIST = MALIGNANT_AUG_DATASET_ROOT / "train_rgb_mask_cls.txt"
VAL_LIST = MASK_AWARE_DATASET_ROOT / "val_rgb_mask_cls.txt"

# Original labels 0-6 are grouped as non-malignant/other.
# Original label 7 is high-grade serous carcinoma (malignant).
BINARY_LABEL_MAP = {
    0: 0,
    1: 0,
    2: 0,
...
# Training-only synchronized augmentation.
USE_AUGMENTATION = True
MALIGNANT_AUGMENTED_COPIES = 4
MALIGNANT_ORIGINAL_LABEL = 7
MALIGNANT_AUGMENTATION_SEED = 42
...
BEST_MODEL_PATH = CHECKPOINT_DIR / "best_binary_malignant_aug4_focal_mtaswin.pth"
LAST_MODEL_PATH = CHECKPOINT_DIR / "last_binary_malignant_aug4_focal_mtaswin.pth"

RESULTS_DIR = (
    PROJECT_ROOT
    / "classification_results"
    / "ds2net_maskaware_mtaswin_aug_focal_binary_malignant_aug"
)
TRAINING_HISTORY_PATH = RESULTS_DIR / "training_history.csv"
TRAINING_LOSS_CHART_PATH = RESULTS_DIR / "training_curves.png"
MALIGNANT_F1_CHART_PATH = RESULTS_DIR / "malignant_f1_curve.png"
