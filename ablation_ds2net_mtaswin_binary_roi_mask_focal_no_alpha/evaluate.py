...
from ablation_ds2net_mtaswin_binary_roi_mask_focal_no_alpha import config
from ablation_ds2net_mtaswin_binary_roi_mask_focal_no_alpha.dataset import (
    ROIMaskBinaryDataset,
)
from ablation_ds2net_mtaswin_binary_roi_mask_focal_no_alpha.model import (
...
def main():
    ...
    for batch in tqdm(
        loader,
        desc="Evaluating focal-loss no-alpha ablation",
    ):
        (
            roi_images,
            masks,
