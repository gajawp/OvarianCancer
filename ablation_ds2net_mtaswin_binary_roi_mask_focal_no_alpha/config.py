...
FOCAL_GAMMA = 2.0
# A7 ablation: retain focal focusing (gamma=2) but remove class alpha weights.
...
BEST_MODEL_PATH = (
    CHECKPOINT_DIR / "best_binary_roi_mask_focal_no_alpha.pth"
)

LAST_MODEL_PATH = (
    CHECKPOINT_DIR / "last_binary_roi_mask_focal_no_alpha.pth"
)
