...
class DualContextNoMaskMTASwin(nn.Module):
    def __init__(
        self,
        num_classes=2,
        pretrained=True,
        ...
        context_backbone = resnet18(weights=resnet_weights)
        context_feature_dim = context_backbone.fc.in_features
        context_backbone.fc = nn.Identity()
        self.context_backbone = context_backbone

        fused_dim = roi_feature_dim + context_feature_dim
...
def create_dual_context_model(
    ...
    return DualContextNoMaskMTASwin(
