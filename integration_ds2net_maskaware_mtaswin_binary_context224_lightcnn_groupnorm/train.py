...
from integration_ds2net_maskaware_mtaswin_binary_context224_lightcnn_groupnorm import config
from integration_ds2net_maskaware_mtaswin_binary_context224_lightcnn_groupnorm.dataset import (
    DualContextBinaryDataset,
)
from integration_ds2net_maskaware_mtaswin_binary_context224_lightcnn_groupnorm.model import (
...
def main():
    ...
    print("=" * 88)
    print(
    "DUAL-CONTEXT MASK-AWARE MTA-SWIN "
    f"BINARY CLASSIFICATION AT {config.IMAGE_SIZE}x{config.IMAGE_SIZE}"
    )
    print("=" * 88)
