...
from ablation_ds2net_mtaswin_binary_roi_mask_no_context import config
from ablation_ds2net_mtaswin_binary_roi_mask_no_context.dataset import (
    ROIMaskBinaryDataset,
)
from ablation_ds2net_mtaswin_binary_roi_mask_no_context.model import (
...
def main():
    ...
    print("=" * 88)
    print(
        "ABLATION A2: ROI + MASK MTA-SWIN WITHOUT FULL-IMAGE CONTEXT "
