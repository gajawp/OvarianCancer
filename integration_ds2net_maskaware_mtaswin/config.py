...
CHECKPOINT_DIR = (
    PROJECT_ROOT / "integration_ds2net_maskaware_mtaswin" / "checkpoints"
)
BEST_MODEL_PATH = CHECKPOINT_DIR / "best_ds2net_maskaware_mtaswin.pth"
LAST_MODEL_PATH = CHECKPOINT_DIR / "last_ds2net_maskaware_mtaswin.pth"

RESULTS_DIR = (
    PROJECT_ROOT / "classification_results" / "ds2net_maskaware_mtaswin"
)
