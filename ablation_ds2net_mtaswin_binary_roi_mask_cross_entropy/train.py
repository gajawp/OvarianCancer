...
from ablation_ds2net_mtaswin_binary_roi_mask_cross_entropy.dataset import (
...
def main():
    ...
    print("=" * 88)
    print(
        "ABLATION A4: ROI + MASK MTA-SWIN WITH CROSS-ENTROPY LOSS "
    ...
    print("Loss function: standard unweighted cross-entropy")
