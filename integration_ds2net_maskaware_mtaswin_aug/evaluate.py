...
from integration_ds2net_maskaware_mtaswin_aug.dataset import (
...
from integration_ds2net_maskaware_mtaswin_aug.model import (
...
def main():
    ...
    for rgb_images, masks, labels, image_names in tqdm(
        loader,
        desc="Evaluating augmented mask-aware MTA-Swin",
    ):
