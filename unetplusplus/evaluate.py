...
def extract_final_logits(model_output):
    """
    Extract the final segmentation output from U-Net++.

    The last deep-supervision output is used as the final
    prediction.
    """
...
def main():
    """
    Evaluate U-Net++ on the official held-out test set
    defined by val_cls.txt.
    """
    ...
    print("=" * 70)
    print("U-Net++ Official Test Evaluation")
    print("=" * 70)
    ...
    qualitative_directory = Path(
        config.UNETPLUSPLUS_RESULTS_DIR
    )
    ...
    with torch.no_grad():
        ...
        for index, batch in enumerate(
            ...
            # Save first 30 qualitative results.
            if index < 30:
    ...
    print("\n" + "=" * 70)
    print("U-Net++ official test evaluation completed")
    print("=" * 70)
