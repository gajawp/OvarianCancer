...
# A3 ablation: disable all training-time geometric and intensity augmentation.
...
BEST_MODEL_PATH = (
    CHECKPOINT_DIR / "best_binary_roi_mask_no_augmentation.pth"
)

LAST_MODEL_PATH = (
    CHECKPOINT_DIR / "last_binary_roi_mask_no_augmentation.pth"
)
