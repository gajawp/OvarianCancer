...
from ablation_ds2net_mtaswin_binary_roi_mask_no_augmentation import config
from ablation_ds2net_mtaswin_binary_roi_mask_no_augmentation.dataset import (
    ROIMaskBinaryDataset,
)
from ablation_ds2net_mtaswin_binary_roi_mask_no_augmentation.model import (
...
def create_loaders():
    train_dataset = ROIMaskBinaryDataset(
    ...
    val_dataset = ROIMaskBinaryDataset(
...
def main():
    ...
    print("=" * 88)
    print(
        "ABLATION A3: ROI + MASK MTA-SWIN WITHOUT AUGMENTATION "
