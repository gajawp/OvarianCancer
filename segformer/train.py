...
def train_one_epoch(
    ...
    if total_samples == 0:
        raise RuntimeError(
            "The SegFormer training DataLoader "
...
def save_checkpoint(
    ...
    """
    Save SegFormer model weights and training metadata.
    """
...
def main():
    """
    Train SegFormer using only the official training split.
    ...
    print("=" * 70)
    print("SegFormer Segmentation Training")
    print("=" * 70)
    ...
    print(
        "\nRun segformer.evaluate to calculate final "
