...
def extract_final_logits(model_output):
    """
    Extract final segmentation logits from SegFormer output.
    """
    ...
    if isinstance(model_output, (tuple, list)):
        if len(model_output) == 0:
            raise ValueError(
                "SegFormer returned an empty tuple or list."
            )
    ...
    if isinstance(model_output, dict):
        ...
        raise KeyError(
            ...
            "SegFormer output dictionary."
        )

    raise TypeError(
        "Unsupported SegFormer output type: "
...
def save_qualitative_result(
    ...
    if image_name is not None:
        ...
        output_filename = (
            f"segformer_result_{index:03d}.png"
        )
...
def main():
    """
    Evaluate SegFormer on the official held-out segmentation
    ...
    print("=" * 70)
    print("SegFormer Official Test Evaluation")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("SegFormer official test evaluation completed")
    print("=" * 70)
