...
def preprocess_image(image_path):
    ...
    image_tensor = torch.from_numpy(normalized_image).float().unsqueeze(0)
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate a SegFormer segmentation mask."
    )
    parser.add_argument("image_path")
    parser.add_argument("--output", default="segformer_prediction.png")
    ...
    original_image, resized_image, image_tensor = preprocess_image(
