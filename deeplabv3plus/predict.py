...
def main():
    parser = argparse.ArgumentParser(
        description="Generate a DeepLabV3+ segmentation mask."
    )
    parser.add_argument("image_path")
    parser.add_argument(
        "--output",
        default="deeplabv3plus_prediction.png",
    )
    ...
    checkpoint_path = config.DEEPLABV3PLUS_MODEL_PATH
    ...
    original_image, resized_image, image_tensor = (
