...
from ablation_ds2net_mtaswin_binary_roi_mask_bilinear_resize import config
from ablation_ds2net_mtaswin_binary_roi_mask_bilinear_resize.dataset import (
    ROIMaskBinaryDataset,
)
from ablation_ds2net_mtaswin_binary_roi_mask_bilinear_resize.model import (
...
def main():
    ...
    print("=" * 88)
    print(
        "ABLATION A6: ROI + MASK WITH BILINEAR MASK RESIZING "
