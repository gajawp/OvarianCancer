...
def extract_final_logits(model_output):
    ...
    if isinstance(model_output, (tuple, list)):
        ...
        # The first output is treated as the final prediction.
...
def train_one_epoch(
    ...
    """
    Train Attention U-Net for one epoch.
    ...
    for batch in progress_bar:
        ...
        # Uses all outputs when Attention U-Net returns
...
def main():
    """
    Train Attention U-Net using only the official training
    partition.
    ...
    print("=" * 70)
    print("Attention U-Net Segmentation Training")
    print("=" * 70)
    ...
    # Training loss is used because the official test set
    ...
    checkpoint_path = (
        config.ATTENTION_UNET_MODEL_PATH
    )
    ...
    print(
        "\nRun the evaluation command to calculate final "
