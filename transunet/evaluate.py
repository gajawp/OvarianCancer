...
def extract_final_logits(model_output):
    """
    Extract final segmentation logits from TransUNet output.
    """
...
def save_qualitative_result(
    ...
    if image_name is not None:
        ...
        output_filename = (
            f"transunet_result_{index:03d}.png"
        )
...
def main():
    """
    Evaluate TransUNet on the official held-out segmentation
    ...
    print("=" * 70)
    print("TransUNet Official Test Evaluation")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("TransUNet official test evaluation completed")
    print("=" * 70)
