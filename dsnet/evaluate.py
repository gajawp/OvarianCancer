...
def main():
    """
    Evaluate DSNet on the official held-out segmentation
    ...
    print("=" * 70)
    print("DSNet Official Test Evaluation")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("DSNet official test evaluation completed")
    print("=" * 70)
